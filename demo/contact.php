...
if(isset($_POST['email'])) {
			...
			$to = 'yogeshwaranworld@gmail.com,rajesh.td@gmail.com';							
			...
			$rlymessage = "";
			$rlymessage .= '<html><body><table width="100%" cellpadding="5" cellspacing="0" border="0" style="font-size:14px;"><tr><td colspan="2" align="center"><a href="http://www.xvalueinc.com/"><img src="http://www.xvalueinc.com/demo/assets/images/logo.png"></a></td></tr>';
			...
			if (mail($to, $subject, $message, $headers))
			 {
				mail($email, $rlysubject, $rlymessage, $headers);
             	header("Location:http://www.xvalueinc.com/demo/"); 
